        ...
        <div class="main">
            ...
            <div class="main-data">
                <div class="left-div" style="font-size:15px; line-height: 1.5;">
                    ...
                    <div class="info">
                        <span class="capitalize">{{$anggota->nama_lengkap}}</span><br>
                        <span class="text-md">ID: {{$anggota->id}}</span><br>
                        <span class="text-md">alamat: {{$anggota->id}}</span><br>
                        <span class="text-md">telepon: {{$anggota->hp}}</span><br>
                        <span class="text-md">Posisi Pemain {{$anggota->ssb_pemain}}</span><br>
                    </div>
                </div>
                <div class="right-div" style="padding-left: 50px">
                    <img style="height: 80px; margin-left:15px;; margin-top:25px;"
                        src="{{public_path('anggota/images/' . $anggota->avatar)}}" alt="" width="75">
                    <div class="flex items-center" style="margin-top: 10px;">
                        ...
                        <span class="text-xs ml-2" style="font-size: 13px;">{{$anggota->hp}}</span>
                    </div>
                    <div class="flex items-center">
                        ...
                        <span class="text-xs ml-2" style="font-size: 13px;">{{$anggota->jenis_kelamin}}</span>
                    </div>
