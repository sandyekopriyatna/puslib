				...
				<div class="col-md-12">
					<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Data Publikasi yang Disetujui Puslibtabmas dan diperiksa Wadir 2</h3>
									<div class="right">
								...
								<div class="panel-body">
									...
									<tr>
										...
										<td><a href ="{{url('/publikasi/profilelengkap',$publikasi->id)}}">{{$publikasi ->judul}}</td>
										<td>{{$publikasi ->user->name}}</a></td>
