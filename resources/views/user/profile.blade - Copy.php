...
@section ('content')
<div class="main" style="min-height: 927px;">
			<!-- MAIN CONTENT -->
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										...
										<h3 class="name">{{$anggota->nama_depan}}</h3>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											...
											<li>Jenis Kelamin <span>{{$anggota->jenis_kelamin}}</span></li>
											<li>Agama <span>{{$anggota->agama}}</span></li>
